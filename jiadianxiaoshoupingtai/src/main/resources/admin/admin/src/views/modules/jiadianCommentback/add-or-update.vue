            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="jiadianCommentbackText">
                        <el-input type="textarea"  :readonly="ro.jiadianCommentbackText" v-model="ruleForm.jiadianCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.jiadianId = true;//商品
                this.ro.yonghuId = true;//用户
                this.ro.jiadianCommentbackText = true;//评价内容
            }
