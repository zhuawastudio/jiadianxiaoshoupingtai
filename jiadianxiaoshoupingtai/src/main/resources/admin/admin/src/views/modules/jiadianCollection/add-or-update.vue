    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="jiadianCollectionTypes">
                        <el-select v-model="ruleForm.jiadianCollectionTypes" :disabled="ro.jiadianCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in jiadianCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        ...
                        <el-input v-model="ruleForm.jiadianCollectionValue"
        ...
        data() {
            return {
                ...
                ruleForm: {
                    jiadianId: '',
                    yonghuId: '',
                    jiadianCollectionTypes: '',
                    insertTime: '',
                },
                jiadianCollectionTypesOptions : [],
                jiadianOptions : [],
                yonghuOptions : [],
                rules: {
                   jiadianId: [
