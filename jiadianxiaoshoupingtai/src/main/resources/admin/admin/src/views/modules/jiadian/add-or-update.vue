            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品名称" prop="jiadianName">
                       <el-input v-model="ruleForm.jiadianName"
                                 placeholder="商品名称" clearable  :readonly="ro.jiadianName"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品编号" prop="jiadianUuidNumber">
                       <el-input v-model="ruleForm.jiadianUuidNumber"
                                 placeholder="商品编号" clearable  :readonly="ro.jiadianUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="商品类型" prop="jiadianTypes">
                        <el-select v-model="ruleForm.jiadianTypes" :disabled="ro.jiadianTypes" placeholder="请选择商品类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="jiadianKucunNumber">
                       <el-input v-model="ruleForm.jiadianKucunNumber"
                                 placeholder="商品库存" clearable  :readonly="ro.jiadianKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="jiadianOldMoney">
                       <el-input v-model="ruleForm.jiadianOldMoney"
                                 placeholder="商品原价" clearable  :readonly="ro.jiadianOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="jiadianNewMoney">
                       <el-input v-model="ruleForm.jiadianNewMoney"
                                 placeholder="现价" clearable  :readonly="ro.jiadianNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    jiadianName: '',
                    jiadianUuidNumber: new Date().getTime(),
                    jiadianPhoto: '',
                    jiadianTypes: '',
                    jiadianKucunNumber: '',
                    jiadianOldMoney: '',
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.jiadianContent = _this.ruleForm.jiadianContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.jiadianContent = this.ruleForm.jiadianContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`jiadian/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
            ...
            jiadianPhotoUploadChange(fileUrls){
                this.ruleForm.jiadianPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
