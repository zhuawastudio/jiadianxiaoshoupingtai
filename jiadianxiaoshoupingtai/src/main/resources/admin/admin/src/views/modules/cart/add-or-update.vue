            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiadian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="jiadianOldMoney">
                        <el-input v-model="jiadianForm.jiadianOldMoney"
                                  placeholder="商品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品原价" prop="jiadianOldMoney">
                            <el-input v-model="ruleForm.jiadianOldMoney"
                                      placeholder="商品原价" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='jiadian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品热度" prop="jiadianClicknum">
                        <el-input v-model="jiadianForm.jiadianClicknum"
                                  placeholder="商品热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品热度" prop="jiadianClicknum">
                            <el-input v-model="ruleForm.jiadianClicknum"
