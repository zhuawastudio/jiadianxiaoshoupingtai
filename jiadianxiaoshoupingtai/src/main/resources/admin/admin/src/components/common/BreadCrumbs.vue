<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:30px;backgroundColor:var(--publicMainColor);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px var(--publicSubColor);borderWidth:5px;borderStyle:double;borderColor:var(--publicSubColor);">
