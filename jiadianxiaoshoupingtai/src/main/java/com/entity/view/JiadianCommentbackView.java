...
public class JiadianCommentbackView extends JiadianCommentbackEntity implements Serializable {
	...
	public JiadianCommentbackView(JiadianCommentbackEntity jiadianCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, jiadianCommentbackEntity);
