...
*/
@TableName("jiadian")
public class JiadianView extends JiadianEntity implements Serializable {
	...
	*/
	...
	public JiadianView(JiadianEntity jiadianEntity) {
		try {
			BeanUtils.copyProperties(this, jiadianEntity);
