...
public class JiadianOrderView extends JiadianOrderEntity implements Serializable {
	...
	*/
	...
	private String jiadianOrderValue;
	/**
	* 支付类型的值
	*/
	@ColumnInfo(comment="支付类型的字典表值",type="varchar(200)")
	private String jiadianOrderPaymentValue;
	...
	public JiadianOrderView() {

	}

	public JiadianOrderView(JiadianOrderEntity jiadianOrderEntity) {
		try {
			BeanUtils.copyProperties(this, jiadianOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getJiadianOrderValue() {
		return jiadianOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setJiadianOrderValue(String jiadianOrderValue) {
		this.jiadianOrderValue = jiadianOrderValue;
	}
	//当前表的
	/**
	* 获取： 支付类型的值
	*/
	public String getJiadianOrderPaymentValue() {
		return jiadianOrderPaymentValue;
	}
	/**
	* 设置： 支付类型的值
	*/
	public void setJiadianOrderPaymentValue(String jiadianOrderPaymentValue) {
		this.jiadianOrderPaymentValue = jiadianOrderPaymentValue;
	}
	...
	public String toString() {
		return "JiadianOrderView{" +
			", jiadianOrderValue=" + jiadianOrderValue +
			", jiadianOrderPaymentValue=" + jiadianOrderPaymentValue +
