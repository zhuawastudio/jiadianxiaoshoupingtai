...
public class JiadianOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiadianOrderEntity() {

	}

	public JiadianOrderEntity(T t) {
		try {
    ...
    public String toString() {
        return "JiadianOrder{" +
            ", id=" + id +
            ", jiadianOrderUuidNumber=" + jiadianOrderUuidNumber +
            ", addressId=" + addressId +
            ", jiadianId=" + jiadianId +
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
            ", jiadianOrderTruePrice=" + jiadianOrderTruePrice +
            ", jiadianOrderCourierName=" + jiadianOrderCourierName +
            ", jiadianOrderCourierNumber=" + jiadianOrderCourierNumber +
            ", jiadianOrderTypes=" + jiadianOrderTypes +
            ", jiadianOrderPaymentTypes=" + jiadianOrderPaymentTypes +
